...
## [Unreleased]
## [0.5.1-beta.4] - 2026-08-10

### Fixed
- Fix: brightness commands repeat N times for multi-step changes


## [0.5.1-beta.3] - 2026-08-06

### Fixed
- Fix: brightness down never fires with fewer than 100 brightness steps


## [0.5.1-beta.2] - 2026-08-06

### Fixed
- Fix: auto-copy built-in SmartIR profiles to custom_codes/ for editing and learning (#44)


## [0.5.1-beta.1] - 2026-07-25

### Fixed
- Fix entities not appearing in Home Assistant after Generate Entities

- Auto-ensure configuration.yaml includes broadlink_manager package include
- Fix diagnostics false negative for HA connection in supervisor mode
- Add HA URL to diagnostics report
